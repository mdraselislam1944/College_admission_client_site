        ...
        <div>
           {
            colleges[0]?<>
            {
                colleges.map(data => <div key={data._id} className="card lg:card-side bg-base-100 shadow-xl mx-10 my-5 ">
            ...
            </>:<h1 className='text-center text-5xl my-10 text-orange-300 text-bold'>This college not here</h1>
           }
        </div>
    );
};

export default SearchingCollege; 